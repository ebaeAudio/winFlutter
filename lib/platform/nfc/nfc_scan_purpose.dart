...
String nfcStartAlertMessage(NfcScanPurpose p) {
  return switch (p) {
    NfcScanPurpose.pair =>
      'Ready to scan. Keep your phone unlocked and hold the NFC card/tag near the top of your phone.',
    NfcScanPurpose.validateStart =>
      'Ready to scan. Keep your phone unlocked and hold your paired NFC card/tag near the top of your phone.',
